...
public class HourlyElectricityServiceImpl implements HourlyElectricityService {
	...
	public List<DailyElectricity> ElectricityByPanelSerialAndDate(Long panelSerial) {
		return hourlyElectricityRepository.getElectrycityByDay(panelSerial,LocalDate.now());
	}
